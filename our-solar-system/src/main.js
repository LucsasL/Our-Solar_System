...
const neptuneTex = textureLoader.load("/textures/2k_neptune.jpg");
neptuneTex.ColorSpace = THREE.SRGBColorSpace;

const moonTex = textureLoader.load("/textures/2k_moon.jpg");
